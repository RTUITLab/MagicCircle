...
<div class="admin-panel">
  ...
  <div class="wrapper-panel">
    <div class="header-panel">
      <button class="btn btn-primary btn-header" @click="addDelChange = true;"> Добавить </button>
      <button class="btn btn-primary btn-header" @click="addDelChange = false"> Удалить</button>
    </div>
    <div class="add-section" v-if="addDelChange">
      <div class="add-form">
        <h3> Добавить сектор</h3>
    ...
    <div class="del-section" v-if="addDelChange === false">
      <div class="del-form">
        <h3> Удалить институт</h3>
        <input type="number" class="form-control" placeholder="Введите id института" v-model="delValueInst">
        <button type="submit" @click="delInstitute" class="btn btn-danger">Удалить</button>
      </div>
      <div class="del-form">
        <h3> Удалить направление</h3>
        <input type="number" class="form-control" placeholder="Введите id института" v-model="delValueDirect">
        <button type="submit" @click="delDirection" class="btn btn-danger">Удалить</button>
      </div>
      <div class="del-form">
        <h3> Удалить профиль</h3>
        <input type="number" class="form-control" placeholder="Введите id института" v-model="delValueProfile">
...
export default {
  ...
  methods: {
    ...
    delInstitute() {
      console.log('delInstitute', this.delValueInst)
      api.deleteInstituteFromApi(this.delValueInst)
    },
    delProfile() {
